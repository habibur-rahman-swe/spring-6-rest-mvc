package habib.springframework.springrest6mvc.bootstrap;
...
public class BootstrapData implements CommandLineRunner {
	...
	private void loadBeerData() {
		...
		if (beerRepository.count() == 0) {
			Beer beer1 = Beer.builder().beerName("Galaxy Cat").beerStyle(BeerStyle.PALE_ALE).upc("123455")
					.price(new BigDecimal("12.99")).quantityOnHand(222).createdDate(LocalDateTime.now())
